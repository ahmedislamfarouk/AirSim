...
\begin{itemize}
    \item Multi-drone collaborative mapping and localization in simulated disaster environments (snow, rain, fire).
    \item Real-time SLAM using RTAB-Map integrated with AirSim and ROS2, visualized in RViz2.
    \item Real-time object detection using YOLO, with results visualized in RViz2.
    \item Live monitoring and control via ROS2 topics and QGroundControl.
    \item Visualization of federated learning and distributed AI experiments (in progress).
\end{itemize}
